...
const COMPLAINTS = [
  { id: 'back', label: 'Rücken & Nacken', sub: 'Verspannungen, Rückenschmerzen oder Haltung.', image: 'https://media.base44.com/images/public/69fd9350879c9d422990f406/0e2ab8c51_generated_image.png', color: 'from-orange-700/70' },
  { id: 'joints', label: 'Knie, Hüfte & Gelenke', sub: 'Belastung, Bewegungseinschränkung oder Unsicherheit.', image: 'https://media.base44.com/images/public/69fd9350879c9d422990f406/719bbe318_generated_image.png', color: 'from-red-700/70' },
  { id: 'strength', label: 'Kraft & Stabilität', sub: 'Ich fühle mich schwach, instabil oder unsicher.', image: 'https://media.base44.com/images/public/69fd9350879c9d422990f406/648ec5daf_generated_image.png', color: 'from-blue-700/70' },
  { id: 'everyday', label: 'Beweglichkeit & Alltag', sub: 'Bücken, Aufstehen oder Treppen fallen schwer.', image: 'https://media.base44.com/images/public/69fd9350879c9d422990f406/677b02582_generated_image.png', color: 'from-teal-700/70' },
];
